...
;(function(window) {
	...
	CircleSlideshow.prototype._init = function() {
		...
		this.navLeftCtrl.innerHTML = '<svg width="100px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none" stroke="#ff0000" stroke-width="5" points="69.821,3.795 92.232,26.205 0,26.205"/></svg>';
		...
		this.navRightCtrl.innerHTML = '<svg width="100px" height="30px" viewBox="0 0 100 30"><polyline class="navbutton__line" fill="none" stroke="#ff0000" stroke-width="5" points="30.179,26.205 7.768,3.795 100,3.795"/></svg>';
